...
docker-compose -f "${DOCKER_FILE}" down --volumes --remove-orphan
...
# Create the channel
docker exec peer0.grower.hc.com peer channel create -o orderer.hc.com:7050 -c composerchannel -f /etc/hyperledger/configtx/composer-channel.tx

# Join peer0.org1.example.com to the channel.
docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@grower.hc.com/msp" peer0.grower.hc.com peer channel join -b composerchannel.block
